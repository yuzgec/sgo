        ...
        <div class="card">
            ...
            <div class="table-responsive p-2">
                <table class="table table-hover table-striped table-bordered table-center">
                    ...
                    <tr id="page_{{$item->id}}">
                        <td>
                            <span class="avatar me-2" style="background-image: url({{ (!$item->getFirstMediaUrl('page')) ? '/backend/resimyok.jpg': $item->getFirstMediaUrl('page', 'thumb')}})"></span>
                        </td>
                        <td>
                            <div class="font-weight-medium">
                                <a href="{{ route('blog.edit', $item->id) }}" title="{{ $item->title }} - Düzenle">
                                    {{ $item->title }}
                                </a>
                            </div>
                        </td>
