<div class="card bg-dark border-0 border-radius-0 custom-box-shadow-1" id="form">
    <div class="card-body">
        <h3 class="text-transform-none text-white font-weight-bold mb-5">HIZLI İLETİŞİM FORMU</h3>
